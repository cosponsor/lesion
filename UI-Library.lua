function initLibrary()
	...
	function utility.create(class, properties, extra)
	...
	function library:Load(opts)
		...
		local dragSpeed = options.dragSpeed or .1
		...
		utility.create("TextLabel", {
			...
			Position = UDim2.new(0, sizeX / 2, 0, 0),
		...
		function windowTypes:Tab(name)
			...
			function tabTypes:Section(opts)
				...
				Instance.new("UICorner", sectionHolder).CornerRadius = UDim.new(0,4)
				...
				function sectionTypes:Button(opts, risky)
					local options = utility.table(opts)
					...
					if risky == true then
						color = Color3.fromRGB(144, 21, 21)
					end
				...
				function sectionTypes:Toggle(opts, risky)
					local options = utility.table(opts)
					...
					if risky == true then
						color = Color3.fromRGB(255, 37, 37)
					end
					local title = utility.create("TextLabel", {
						ZIndex = 3,
						Size = UDim2.new(0, 0, 1, 0),
				...
				function sectionTypes:Box(opts)
					...
					Instance.new("UICorner", boxHolder).CornerRadius = UDim.new(0,4)
				...
				function sectionTypes:ToggleSlider(opts, risky)
					local options = utility.table(opts)
				...
				function sectionTypes:ToggleKeybind(opts, risky)
					local options = utility.table(opts)
				...
				function sectionTypes:ToggleColorPicker(opts)
					...
					Instance.new("UICorner", toggleColorPickerHolder).CornerRadius = UDim.new(0,4)
					...
					Instance.new("UICorner", colorPicker).CornerRadius = UDim.new(0,4)
					...
					Instance.new("UICorner", colorPickerIcon).CornerRadius = UDim.new(0,4)
